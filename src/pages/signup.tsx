    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-8">
        <div className="w-full max-w-[400px]">
          <div className="mb-8">
            <h2 className="text-[28px] font-extrabold tracking-tight text-gray-900">Create your account</h2>
            <p className="mt-2 text-[15px] text-gray-500">Start your Amazon FBA journey today — it's free</p>
          </div>
          ...
          <p className="text-center text-[14px] text-gray-500">
            ...
            <button onClick={() => setLocation("/login")} className="font-semibold text-indigo-600 hover:text-indigo-700">Sign in</button>
          </p>
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-5 mt-8">
            <h1 className="text-[40px] font-extrabold leading-[1.1] tracking-tight text-white">
              Join 500+<br />sellers<br />
              <span className="text-white/70">growing together</span>
            </h1>
            <p className="max-w-[400px] text-[16px] leading-relaxed text-white/60">
              Get instant access to AI analytics, expert courses, product leads, and a thriving community.
            </p>
          </div>
        </div>
