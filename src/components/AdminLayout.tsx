    ...
    <div className="flex min-h-screen bg-gray-50/50">
      <aside className="fixed inset-y-0 left-0 z-30 flex w-[260px] flex-col border-r border-gray-200 bg-white">
        <div className="flex items-center gap-3 border-b border-gray-100 px-5 py-5">
          ...
          <div>
            <div className="text-[15px] font-bold tracking-tight text-gray-900">Plug Akademi</div>
            <div className="text-[11px] font-medium text-gray-400">Admin Panel</div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 p-4">
          <div className="mb-1 truncate text-[13px] font-medium text-gray-700">{profile?.email}</div>
          <div className="mb-3 text-[11px] font-semibold uppercase tracking-wider text-indigo-600">{profile?.role}</div>
          <button
            onClick={logout}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-[13px] font-medium text-gray-500 transition-all hover:bg-gray-50 hover:text-red-600 hover:border-red-200"
          >
            <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9" /></svg>
            Sign Out
          </button>
        </div>
      </aside>
