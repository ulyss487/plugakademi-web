const TOOLS = [
  ...
  },
  {
    ...
    subtitle: "Compare and maximize profits",
    desc: "See exactly how much you'll make selling on Amazon vs Walmart side-by-side. Compare fees, FBA vs WFS costs, and net margins to pick the most profitable marketplace for every product.",
    features: ["Amazon vs Walmart comparison", "Full fee breakdown", "Side-by-side margins", "Best marketplace recommendation"],
    ...
    <section id="tools" className="mx-auto max-w-7xl px-6 py-24 md:py-32 lg:px-8">
      <div className="mx-auto mb-20 max-w-2xl text-center">
        ...
        <p className="text-[17px] leading-relaxed text-gray-500">
          Every tool is built with the same rigor used by 5 and 6-figure sellers. No feature gates, no trials, no hidden costs.
        </p>
      </div>
